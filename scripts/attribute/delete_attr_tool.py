...
class deleteAttrTool(QtWidgets.QWidget):
    def __init__(self, parent=None):
        super(deleteAttrTool, self).__init__(parent)
        version = "001"
        ui_object_name = f"deleteAttrTool{version}"
        ui_window_name = f"Delete attr tool V{version}"
